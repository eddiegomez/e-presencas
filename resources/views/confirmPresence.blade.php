    ...
    <div class="col-12 col-md-4 mx-auto">
      <div href="/event/{{ $event->id }}" class="card position-relative">
        ...
        <div class="card-body z-10">
          <h2 class="card-text text-center">{{ $event->name }}</h2>
          <div class="d-flex justify-content-between mt-2">
            <span class="font-weight-bolder font-size-16">Data</span>
            <span class="font-weight-medium font-size-16">{{ $event->date }}</span>
          </div>
          <div class="d-flex justify-content-between mt-2">
          ...
          <div class="d-flex justify-content-between mt-2">
            <span class="font-weight-bolder font-size-16">Hora</span>
            <span class="font-weight-medium font-size-16">{{ $event->date }}</span>
          </div>
          <div class="d-flex justify-content-between mt-2">
            <span class="font-weight-bolder font-size-16">Duracao</span>
            <span class="font-weight-medium font-size-16">{{ $event->date }}</span>
          </div>
